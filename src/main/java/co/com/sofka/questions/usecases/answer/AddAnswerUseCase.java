...
public class AddAnswerUseCase implements SaveAnswer {
    ...
    private final GetQuestionUseCase getUseCase;

    public AddAnswerUseCase(MapperUtils mapperUtils, GetQuestionUseCase getUseCase, AnswerRepository answerRepository) {
